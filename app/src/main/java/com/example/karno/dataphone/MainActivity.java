package com.example.karno.dataphone;
...
import com.example.karno.dataphone.adapter.ListAdapterHandphone;
import com.example.karno.dataphone.model.Handphone;
import com.example.karno.dataphone.server.AsyncInvokeURLTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amCallback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                getMenuInflater().inflate(R.menu.main_action,
                        menu);
                return true;
            }
            @Override
            public boolean onActionItemClicked(ActionMode mode, MenuItem item)
            {
                switch(item.getItemId()){
                    case R.id.action_menu_edit:showUpdateForm();
                        break;
